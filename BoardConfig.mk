...
BOARD_KERNEL_CMDLINE := console=ttyMSM0,115200n8 androidboot.console=ttyMSM0 earlycon=msm_serial_dm,0xa88000 androidboot.hardware=qcom msm_rtb.filter=0x237 lpm_levels.sleep_disabled=1 service_locator.enable=1 swiotlb=1 androidboot.configfs=true androidboot.usbcontroller=a600000.dwc3
...
TARGET_KERNEL_SOURCE := kernel/xiaomi/defan
...
ODM_MANIFEST_JOYEUSE_FILES := $(DEVICE_PATH)/nfc/manifest_joyeuse.xml
...
#BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := 1387436800
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 2587436800
#BOARD_VENDORIMAGE_PARTITION_RESERVED_SIZE := 1187436800
